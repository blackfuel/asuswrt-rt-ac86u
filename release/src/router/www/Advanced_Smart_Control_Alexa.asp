...
.blocking_img{
	...
	background:url(images/New_ui/SmartControl_Alexa.png) no-repeat center;
	margin:auto;
}
...
.step_1{
	...
	background-position:center;
	background-attachment:fixed;
	background:url(images/New_ui/smc_step_1.png) no-repeat center;
	margin:auto;
}
...
.step_2{
	...
	background-position:center;
	background-attachment:fixed;
	background:url(images/New_ui/smc_step_2.png) no-repeat center;
	margin:auto;
}
...
.step_2_text{
	...
	background-position:center;
	background-attachment:fixed;
	background:url(images/New_ui/smc_step_2_text.png) no-repeat center;
	margin:auto 10px;
}
...
.step_3{
	...
	background-position:center;
	background-attachment:fixed;
	background:url(images/New_ui/smc_step_3.png) no-repeat center;
	margin:auto;
}
...
.step_3_acclink{
	...
	background-position:center;
	background-attachment:fixed;
	background:url(images/New_ui/smc_step_3_acclink.png) no-repeat center;
	margin:auto;
...
.and_you_can{
	...
	background-position:center;
	background-attachment:fixed;
	background:url(images/New_ui/smc_step_4_flow.png) no-repeat center;
	margin:auto;
...
.smc_asus_router{
	...
	background-position:center;
	background-attachment:fixed;
	background:url(images/New_ui/smc_asus_router.png) no-repeat center;
...
.smc_blue_cave{
	...
	background-position:center;
	background-attachment:fixed;
	background:url(images/New_ui/smc_blue_cave.png) no-repeat center;
	margin:41px 0px 0px 287px;
	background-size: 146px 146px;
	position: absolute;
}
											...
											<div class="div_tr">
												<div class="div_td div_desc" style="width:55%">
													...
													<div style="padding:0px 40px;font-family:Arial, Helvetica, sans-serif;font-size:13px;">
														...
														<p style="font-family:Arial, Helvetica, sans-serif;font-size:13px;padding-top: 20px;font-style:italic;color:#FFCC00;">Try Saying:</p>
														<p style="font-family:Arial, Helvetica, sans-serif;font-size:13px;padding-left: 20px;font-style:italic;color:#FFCC00;">“Alexa, ask ASUS ROUTER to turn on Guest Network for two hours”</p>
														<p style="font-family:Arial, Helvetica, sans-serif;font-size:13px;padding-left: 20px;font-style:italic;color:#FFCC00">“Alexa, ask ASUS ROUTER to turn off Guest Network”</p>
														<p style="font-family:Arial, Helvetica, sans-serif;font-size:13px;padding-left: 20px;font-style:italic;color:#FFCC00">“Alexa, ask ASUS ROUTER to pause the Internet”</p>
														<p style="font-family:Arial, Helvetica, sans-serif;font-size:13px;padding-top: 2px;padding-left: 20px;font-style:italic;text-decoration: underline;color:#FFCC00;cursor:pointer;">More Skills</p>
													</div>
