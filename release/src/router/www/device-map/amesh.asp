...
function show_connect_result(_status, _newReMac, _model_name) {
	...
	if(_status == "2") {
		...
		$successResult2.css("display", "none");
		...
		var gen_icon_text = function(_class, _text) {
			var $iconBg = $('<div>');
		...
		$aimesh_illustration_bg.append(gen_icon_text("aimesh_modem", "Modem"));/* untranslated */
		$aimesh_illustration_bg.append(gen_icon("aimesh_ethernet"));
		$aimesh_illustration_bg.append(gen_icon_text("aimesh_router", "AiMesh router"));/* untranslated */
		$aimesh_illustration_bg.append(gen_icon("aimesh_ethernet right"));
		$aimesh_illustration_bg.append(gen_icon_text("aimesh_node", "AiMesh node"));/* untranslated */
		...
		var $amesh_dot_bg = $('<div>');
		$amesh_dot_bg.addClass("amesh_dot_bg");
		$amesh_dot_bg.css("margin-top", "15px");
		$connectResultHtml.append($amesh_dot_bg);
		var gen_each_step_dot = function(_idx) {
			var default_dot = 1;
			var $amesh_dot = $('<div>');
			$amesh_dot.addClass("amesh_dot");
			...
			$amesh_dot.click(
				function() {
					parent.$('.amesh_dot').removeClass("click");
					parent.$('#amesh_dot_' + _idx + '').addClass("click");
					parent.$('.amesh_successResult').css("display", "none");
					parent.$('#amesh_successResult_' + _idx + '').css("display", "block");
				}
			);
		};
		var dot_num = 2;
...
function show_search_fail_result() {
	...
	$aimesh_illustration_bg.append(gen_icon("aimesh_ethernet"));
	$aimesh_illustration_bg.append(gen_icon_text("aimesh_router", "AiMesh router"));/* untranslated */
	$aimesh_illustration_bg.append(gen_icon("aimesh_wifi"));
	$aimesh_illustration_bg.append(gen_icon_text("aimesh_node", "AiMesh node"));/* untranslated */
