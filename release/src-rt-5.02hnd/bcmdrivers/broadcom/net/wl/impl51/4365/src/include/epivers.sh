...
#
# $Id: epivers.sh 640137 2016-05-26 09:38:08Z $
#
...
if [ -f epivers.h ]; then
	...
	SVNURL='$HeadURL: http://svn.sj.broadcom.com/svn/wlansvn/proj/tags/EAGLE/EAGLE_REL_10_10_122_308/src/include/epivers.sh $'
