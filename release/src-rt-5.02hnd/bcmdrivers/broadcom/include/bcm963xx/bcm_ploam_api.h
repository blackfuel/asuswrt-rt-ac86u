...
/* IOCTL cmd values 1 and 2 are mapped to FIBMAP and FIGETBSZ on ARM
   ...
   BCM_PLOAM_IOC_CFG_DS_GEM_PORT_ID_ENCRYPTION,   /*Return codes: 0, EINVAL_PLOAM_GEM_PORT, EINVAL_PLOAM_STATE, EINVAL_PLOAM_ARG*/
...
#define BCM_PLOAM_ONU_ID_UNASSIGNED 0xff
